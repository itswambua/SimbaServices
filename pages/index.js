            ...
            <div className="animate-slide-in-left">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-center p-4 bg-orange-50 rounded-lg hover-lift">
                  <div className="text-2xl font-bold text-orange-600">11 Years</div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center hover-lift p-4 rounded-xl bg-green-50 transition-all duration-200 cursor-pointer">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-green-600 font-medium">Sydney & Western Sydney</div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                      ...
                      <div className="space-y-2">
                        ...
                        {errors.phone ? (
                          ...
                          <p className="text-xs text-gray-500">We'll be in touch to discuss your requirements</p>
                        )}
                      </div>
